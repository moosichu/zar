...
This repo contains an in-progress attempt to write an [archiver](https://en.wikipedia.org/wiki/Ar_(Unix)) in [zig](https://ziglang.org/) in order to solve [this issue](https://github.com/ziglang/zig/issues/9828).
