...
pub fn writeAdhocSignature(
    ...
    const total_pages = @as(u32, @intCast(mem.alignForward(opts.file_size, self.page_size) / self.page_size));
    ...
    try self.parallelHash(allocator, macho_file.base.thread_pool, opts.file, opts.file_size);
...
pub fn estimateSize(self: CodeSignature, file_size: u64) u32 {
    ...
    return @as(u32, @intCast(mem.alignForwardGeneric(u64, ssize, @sizeOf(u64))));
}
