...
pub const SegmentCommand = struct {
    ...
    const SegmentOptions = struct {
        ...
        fileoff: u64 = 0,
        filesize: u64 = 0,
        maxprot: macho.vm_prot_t = macho.PROT.NONE,
        initprot: macho.vm_prot_t = macho.PROT.NONE,
        nsects: u32 = 0,
        flags: u32 = 0,
    };
...
test "read-write segment command" {
    ...
    var cmd = SegmentCommand{
        .inner = .{
            ...
            .fileoff = 0,
            .filesize = 294912,
            .maxprot = macho.PROT.READ | macho.PROT.WRITE | macho.PROT.EXEC,
            .initprot = macho.PROT.EXEC | macho.PROT.READ,
            .nsects = 1,
            .flags = 0,
        },
    };
